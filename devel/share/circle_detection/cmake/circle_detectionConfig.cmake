...
if("TRUE" STREQUAL "TRUE")
  set(circle_detection_SOURCE_PREFIX /home/observer/arm_vision/src/circle_detection)
  set(circle_detection_DEVEL_PREFIX /home/observer/arm_vision/devel)
  ...
  set(circle_detection_INSTALL_PREFIX /home/observer/arm_vision/install)
...
if(NOT "/home/observer/arm_vision/src/circle_detection/include " STREQUAL " ")
  set(circle_detection_INCLUDE_DIRS "")
  set(_include_dirs "/home/observer/arm_vision/src/circle_detection/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'circle_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/observer/arm_vision/src/circle_detection/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/observer/arm_vision/devel/lib;/opt/ros/noetic/lib)
...
set(depends "cv_bridge;image_transport;message_filters;roscpp;sensor_msgs")
